				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" id="dubanren" name="dubanren"
							   value="${o.dubanren}" type="text" readOnly/>
					</div>
                    ...
                    <div class="col-sm-4">
						<input class="form-control" id="fenguanlingdao" name="fenguanlingdao"
							   value="${o.fenguanlingdao}" readonly type="text" />
                    </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" id="chengbanchushi" name="chengbanchushi"
							   value="${o.chengbanchushi}" readonly  type="text"/>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<input class="form-control" id="warnday" name="warnday"
							   value="${o.warnday}" type="text" readonly/>
					</div>
					<label class="col-sm-2 control-label" for="finishtime">提醒方式</label>
					<div class="col-sm-4">
						<label>
							<input type="checkbox" class="minimal-red" id="sms" readonly>
							短信
						</label>

						<label>
							<input type="checkbox" class="minimal-red" id="email" readonly>
							邮件
						</label>
