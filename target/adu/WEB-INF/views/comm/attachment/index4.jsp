...
<script>
    ...
    function loadGrid () {
	    ...
	    if ("${mode}" == "RW"){
		    opts.colModel[4].label = '<button onclick="onSelfUpload()" class="btn btn-sm btn-info" type="button"><i class="fa  fa-fw fa-edit"></i>添加附件</button>'
	    }
	    if("${uploadLabel}" != "" && "${mode}" == "RW"){
	    opts.colModel[4].label = '<button onclick="onSelfUpload()" class="btn btn-sm btn-info" type="button"><i class="fa  fa-fw fa-edit"></i>${uploadLabel}</button>'
	     }
	    $ ("#grid").jqGrid (opts);
