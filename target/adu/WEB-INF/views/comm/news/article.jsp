...
<script type="text/javascript">
    ...
    function onSave () {
	    ...
	    $.post (_BasePath + 'comm/news/save', $ ("#mainForm").serialize (), function (result) {
		    $("#id").val(result.entity.id);
		    layer.msg("保存成功");
		    document.location = _BasePath + 'comm/news/index'
	    });
    }
    //ueditor 上传完成后回调
	...
	<div class="container-fluid">
		<form id="mainForm" class="form-horizontal">
			...
			<input type="hidden" id="id" name="id" value="${o.id}" /> <input
				type="hidden" id="template" name="template" value="公告" /><input
