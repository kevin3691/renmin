...
<script type="text/javascript"
 ...
 <script language="javascript">
             ...
             function onSave () {
         	    ...
         	    $.post ('cms/tag/saveTag', $ ("#mainForm").serialize (), function (result) {
         		    if (parent.onSaveOk){
      ...
      <div class="container-fluid">
		...
		<form id="mainForm" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control"  type="text" name="tagName" id="tagName" value="${c.tagName}">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea rows="5" cols="68" name="tagDesc" id="tagDesc" >${c.tagDesc}</textarea>
				</div>
			</div>
