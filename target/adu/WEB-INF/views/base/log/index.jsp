...
<body>
	...
	<ul class="nav nav-tabs" style="padding-top:10px;">
			<li class="active"><a href="base/log/index">日志列表</a></li>
			<li><a href="base/log/systemIndex">系统日志</a></li>
			<li style="float:right;"><div>
					<button class="btn btn-info" id="btnUpload" type="button"
						onclick="onClearAll()">全部清除</button>
					<button class="btn btn-info" id="btnPerUpload" type="button"
						onclick="onClearQuery()">清除查询结果</button>
				</div></li>
		</ul>
