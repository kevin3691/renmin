...
<script type="text/javascript">
    ...
    function genData(days) {
		...
		for (var i = 0; i<= days; i++){
            ...
            html += '<label class="col-sm-2 control-label" for="">上午</label>'
            html += '<div class="col-sm-10">'
            ...
            html += '<label class="col-sm-2 control-label" for="">下午</label>'
            html += '<div class="col-sm-10">'

            html += '<textarea class="form-control days_2" id="'+day+'_2" name="'+day+'_2" rows="3">'

            if("${o.id}" > 0){
                if(day in map)
                    html += map[day].content2
            }
            html += '</textarea>'
            html += '</div>'
...
var map = {}
    ...
    $ (function () {
        ...
        $("#finishtime").on('changeDate',function(ev){
            genWork()
        });
        ...
        if("${o.id}" > 0){
            ...
            entity.content2 = "${p.value.content2}"
