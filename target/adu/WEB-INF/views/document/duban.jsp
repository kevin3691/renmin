...
<script>
	        ...
	        colModel : [
		        	{
	                    ...
	                    formatter : function (value, options, row) {
		                    ...
		                    if(row.yesNo != "yes")
		                    {
		                    	btn += '&nbsp;<a href="javascript:onSave(' + row.refNum + ','+ row.stepId +')" title="">办理</a>'
		                    }else{
    ...
    function onSave (refNum,stepId) {
	    ...
	    document.location = 'document/act?id=' + refNum + '&stepId=' + stepId + '&colTitle=' + encodeURI("${category}");
    }
