...
<head>
	...
	<style>
		...
		.table th, .table td { border-bottom: 1px solid #000;border-right: 1px solid #000;
		}
		.table1 th, .table1 td {border-right: 1px solid #000;
		}
		.title {
			width: 794px;
			text-align: center;
...
<div class="table_box" id="type2"  style="display:none">
	...
	<table width="627" height="701" border="0" bordercolor="#000000" cellspacing="0" class="table">
		<tr>
	...
	<table width="627" height="44" border="0" bordercolor="#000000" cellspacing="0" class="table1">
		<tr>
...
<div class="table_box" id="type6" style="display:none">
	...
	<table width="627" height="701" border="0" bordercolor="#000000" cellspacing="0" class="table">
        ...
        <br />
        见</span></td>
			<td colspan="5"  style="border-bottom:none;">${o.content}</td>
		</tr>
	</table>
	<table width="627" height="44" border="0" bordercolor="#000000" cellspacing="0" class="table1">
		<tr>
