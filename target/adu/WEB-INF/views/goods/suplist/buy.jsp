...
<body>
	<div class="container-fluid">
		...
		<form id="mainForm" class="form-horizontal">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="num">入库数量</label>
				<div class="col-sm-4">
					<input class="form-control" id="num" name="num" value="${o.num}"
						   type="text" required />
				</div>
				<label class="col-sm-2 control-label" for="price">采购价格</label>
				<div class="col-sm-4">
					<input class="form-control" id="price" name="price" value="${o.price}"
						   type="text" required />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="supdate">入库日期</label>
				<div class="col-sm-4">
					<div class="input-group">
						...
						<div class="input-group-addon">
							<i class="fa fa-calendar"
							   onclick="$('#supdate').datetimepicker('show');"></i>
						</div>
					</div>
				</div>
