...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"当前显示第 {from} - {to} 条记录, 共 {total} 条记录"};
})(jQuery);
(function($){
function _7d(_7e){
var _7f=$(_7e);
