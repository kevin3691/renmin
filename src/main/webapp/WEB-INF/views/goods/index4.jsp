...
<script>
	        ...
	        colModel : [
                {
                    ...
                    width : 120
	                    ...
	                    formatter : function (value, options, row) {
		                    var btn = "";
                            btn += '&nbsp;<a href="javascript:onBuy('  + value + ')" title="">入库</a>&nbsp;&nbsp;'
							if(row.quanity > 0){
                                btn += '&nbsp;<a href="javascript:onSell('  + value + ')" title="">领用</a>&nbsp;&nbsp;'
							}else {
                                btn += '&nbsp;<a href="javascript:onSell('  + value + ')" title="" disabled="true" style="pointer-events:none;"><span style="color:grey">领用</span></a>&nbsp;&nbsp;'
							}
    ...
    function onSave (id) {
	    ...
	    layer.open ({
	        ...
	        content : 'goods/edit4?id=' + id + '&goodTypeId=' + _ORGID + "&colSym=BGYP"//iframe的url
	    });
    }
    //添加完成后执行方法
				...
				<div class="nav-tabs-custom">
					...
					<ul class="nav nav-tabs pull-right ui-sortable-handle">
						...
						<li class="pull-right header">
							<button class="btn btn-info"  type="button" onclick="javascript:onOrgNew(_ORGID)">新建分类</button>
