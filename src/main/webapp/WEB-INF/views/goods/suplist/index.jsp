	...
	<script>
            ...
            $ ("#grid").jqGrid ({
                ...
                subGridRowExpanded: function(subgrid_id, row_id) {
                    ...
                    jQuery("#"+subgrid_table_id).jqGrid({
                        url:"goods/suplist/list?type=0&refNum="+row_id,
                        colModel: [
                            {
                                label : '入库日期',
                                name : 'supdate',
                            ...
                            {label:'入库数量',name:"num",index:"num",width:130},
                            {label:'采购价格',name:"price",index:"price",width:70,align:"center"}
                            ,{
                                label : ' ',
                                name : 'id',
                                width : 120,
        ...
        function onSave (id) {
            ...
            layer.open ({
                ...
                content : 'goods/suplist/edit?id=' + id //iframe的url
            });
        }
        //添加完成后执行方法
