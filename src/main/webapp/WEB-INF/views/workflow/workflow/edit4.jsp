...

                {
                ...
                },
	                {
	                    ...
	                    formatter : function (value, options, row) {
		                    var btn = "";
                            btn += '&nbsp;<a href="javascript:onSelPerson(' + value + ')" title="">选择执行人</a>'
...
var _STEPID;
    ...
    function onPersonSelOk (node) {
        $.post ('workflow/step/saveActor',{'personId':node.id,'stepId':_STEPID}, function (result, status) {
            if (result.error){
                layer.msg (result.error);
                return;
            }
		...
		<form id="mainForm" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-5 col-sm-4">
					<select id="isActive" name="isActive" class="form-control select2" readonly>
			...
			<div class="form-group" style="display: none">
				...
				<div class="col-sm-5">
					<input class="form-control" id="category" name="category"
						value="${o.category}" type="text" readonly />
				</div>
