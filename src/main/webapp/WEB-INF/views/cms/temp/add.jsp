...
<body>
	  ...
	  <div class="container-fluid">
		...
		<form id="mainForm" class="form-horizontal" action="<%=request.getContextPath()%>/cms/temp/uploadFile" method="POST" 
			...
			<input type="hidden" id="comFilePath" name="comFilePath" />
			<input type="hidden" id="uncomFilePath" name="uncomFilePath" />
...
<!-- 					<span id="msg_name"  style="display: none">模板名不能为空</span> -->
			...
			<div class="form-group">
            	...
            	<div class="col-sm-4">
						<textarea rows="7" cols="81" name="tempDiscribe" id="tempDiscribe"></textarea>
				</div>
            </div>	
