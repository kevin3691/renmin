	...
	<div class="container-fluid">
		...
		<form id="mainForm" class="form-horizontal">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="title">会议名称</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="location">会议地点</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				...
				<label class="col-sm-2 control-label" for="type">会议类型</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="personNum">参加会议人数</label>
				<div class="col-sm-4">
					<input class="form-control" id="personNum" name="personNum" value="${o.personNum}"
						   type="text"  />
				</div>
				<label class="col-sm-2 control-label" for="total">会议预算费用</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="content">会议内容、进程、会务安排等:</label>
				<div class="col-sm-10">
