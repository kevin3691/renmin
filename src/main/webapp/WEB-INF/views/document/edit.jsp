...
<div class="col-sm-3">
	<ul class="nav nav-tabs" style="padding-top:10px;">
		...
		<li style="float:right;">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="descr">类别</label>
                <div class="col-sm-9">
                <input class="form-control input-sm"
            id="docTypeName" name="docTypeName" value="${o.docTypeName}" type="text" readonly onclick="showMenu()"/>
