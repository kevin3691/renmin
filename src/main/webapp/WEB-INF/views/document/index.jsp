...
<head>
	...
	<script>
        ...
        function onScan () {
            ...
            var url = _BasePath + 'document/liangtian?docTypeId=' + _ORGID
        ...
        function onOrgNew(parentId,id){
            ...
            layer.open ({
                ...
                content : 'doctype/edit?parentId=' + parentId + '&id=' + id //iframe的url
            });
	...
	<div id="uploader" class="wu-example">
		...
		<div class="breadcrumb content-header form-inline"
			...
			<div class="form-group">
				...
				&nbsp;&nbsp;
				<button class="btn btn-info" id="btnAdd" type="button"
						onclick="onSelfUpload()">上传文件</button>
				&nbsp;&nbsp;
				<button class="btn btn-info" id="btnAdd" type="button"
						onclick="onScan()">高拍仪</button>
