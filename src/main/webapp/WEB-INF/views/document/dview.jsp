...
<head>
	...
	<script type="text/javascript">
        ...
        function onPrint() {
            ...
            var _URL = "document/print?id=${o.id}&stepId=1"
            window.open(_URL)
        ...
        function onSave (person) {
            ...
            $.post ('document/act_ins',{"docId":${o.id},"content":$("#content").val(),"insId":${ins.id}}, function (result, status) {
...
<div id="form">
	...
	<div class="container-fluid">
        ...
        <br />
        见</span></td>
							<td  colspan="7" id="8" valign="top"></td>
						</tr>
						<tr>
			...
			<div class="col-sm-3">
				<ul class="nav nav-tabs" style="padding-top:10px;">
					...
					<li style="float:right;">
						<div>
							<button type="button" class="btn btn-master" onclick="onPrint()">打印</button>
							&nbsp;&nbsp;
