...
<script>
	        ...
	        colModel : [
                {
                    ...
                    formatter : function (value, options, row) {
	                    ...
	                    formatter : function (value, options, row) {
		                    var btn = "";
                            btn += '&nbsp;<a href="javascript:onDtl(' + row.typeId + ','  + value + ')" title="">查看</a>'
    ...
    function onSave (orgid,id) {
	    ...
	    layer.open ({
	        ...
	        content : 'workPlan/edit?id=' + id + '&goodTypeId=' + _ORGID + "&colSym=LINGDAO"//iframe的url
	    });
    }
    //添加完成后执行方法
    ...
    function onDtl (orgid,id) {
        ...
        layer.open ({
            ...
            content : 'workPlan/dtl?id=' + id + '&goodTypeId=' + _ORGID + "&colSym=LINGDAO"//iframe的url
        });
    }
    ...
    function onOrgNew(id){
        ...
        layer.open ({
            ...
            content : 'workPlantype/edit?parentId=' + id //iframe的url
        });
