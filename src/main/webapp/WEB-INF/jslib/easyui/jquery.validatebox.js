...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"必填项.",invalidMessage:null,rules:{email:{validator:function(_1f){
...
},message:"请输入正确的邮箱地址."},url:{validator:function(_20){
...
},message:"请输入正确的网址."},length:{validator:function(_21,_22){
var len=$.trim(_21).length;
return len>=_22[0]&&len<=_22[1];
},message:"输入值长度范围为 {0} 到 {1}."},remote:{validator:function(_23,_24){
var _25={};
_25[_24[1]]=_23;
