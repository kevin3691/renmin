...
import com.zzb.core.excel.annotation.Excel;
import com.zzb.core.excel.annotation.ExcelCollection;
import com.zzb.core.excel.annotation.ExcelTarget;
import com.zzb.core.excel.entity.ComparatorExcelField;
import com.zzb.core.excel.entity.ExcelExportEntity;
import com.zzb.core.excel.entity.ExcelTitle;
import com.zzb.core.excel.entity.TemplateExportParams;
	...
	private static void createImageCell(Drawing patriarch, ExcelExportEntity entity, Row row,
		...
		if(entity.getExportImageType()==1){
			...
			try {
				...
				String path = request.getSession().getServletContext().getRealPath("\\") +string;
