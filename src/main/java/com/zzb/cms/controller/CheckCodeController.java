...
/***
 * @author
 * @date 2016年8月9日 下午6:55:53
 * 使用方式：<img src="checkCode/getCode">
 */
@Controller
@RequestMapping("/checkCode")
public class CheckCodeController {
	private int width = 157;// 定义图片的width
	private int height = 50;// 定义图片的height
	public static final int WIDTH = 157; // 我定义的验证吗
	public static final int HEIGHT = 50; // 我定义的高度
	private int codeCount = 6;// 定义图片上显示验证码的个数
	private int codeX = 18;
